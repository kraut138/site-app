...
import { StatusBadge, EmptyState, Icon } from "./UI.jsx";
import { NCRDetail } from "./NCR.jsx";

const SAFETY_ID = "safety";

export default function SafetyOverview({ role, buildings, inspections, ncrs, equipment, unitFloorPlans, onUpdateNcrStatus, onUpdateEquipmentStatus, notify }) {
